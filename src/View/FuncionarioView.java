...
public class FuncionarioView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        TblFuncionario.setFont(new java.awt.Font("Segoe UI Semilight", 0, 16)); // NOI18N
    ...
    private void BtnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSalvarActionPerformed
        ...
        if(TxtLogin.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Necessário um login !","Aviso", JOptionPane.INFORMATION_MESSAGE);
            TxtLogin.requestFocus();
            return;
        }
        if(TxtSenha.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Necessário uma senha !","Aviso", JOptionPane.INFORMATION_MESSAGE);
